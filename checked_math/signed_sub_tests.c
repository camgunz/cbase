...
static void test_s8(int8_t a, int8_t b) {
  ...
  int o1 = checked_ssub8_1(a, b, &r1);
  int o2 = checked_ssub8_2(a, b, &r2);
  int o3 = checked_ssub8_3(a, b, &r3);
  int o4 = checked_ssub8_3(a, b, &r3b);
  int o5 = checked_ssub8_3(a, b, &r3c);
  int o6 = checked_ssub8_3(a, b, &r4);
  int o7 = checked_ssub8_3(a, b, &r5);
  assert(r1 == r2);
  assert(r1 == r3);
  assert(r1 == r3b);
  assert(r1 == r3c);
...
static void test_s16(int16_t a, int16_t b) {
  int16_t r1, r2;
  int o1 = checked_ssub16_1(a, b, &r1);
  int o2 = checked_ssub16_2(a, b, &r2);
  assert(r1 == r2);
  assert(o1 == o2);
}
...
static void test_s32(int32_t a, int32_t b) {
  int32_t r1, r2;
  int o1 = checked_ssub32_1(a, b, &r1);
  int o2 = checked_ssub32_2(a, b, &r2);
  assert(r1 == r2);
  assert(o1 == o2);
}
...
static void test_s64(int64_t a, int64_t b) {
  int64_t r1, r2;
  int o1 = checked_ssub64_1(a, b, &r1);
  int o2 = checked_ssub64_2(a, b, &r2);
  assert(r1 == r2);
  assert(o1 == o2);
}
...
void run_ssub16_tests(unsigned int test_count) {
  puts("Testing 16-bit signed subs");
  edge_test_s16();
  rand_test_s16(test_count);
}

void run_ssub32_tests(unsigned int test_count) {
  puts("Testing 32-bit signed subs");
  edge_test_s32();
  rand_test_s32(test_count);
}

void run_ssub64_tests(unsigned int test_count) {
