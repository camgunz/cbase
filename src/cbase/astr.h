...
void string_zero_data_fast(String *array, size_t index, size_t count);
...
void string_set_many_fast(String *array,
                          size_t index,
                          const char *data,
                          size_t count);
int string_set_many(String *array,
                    size_t index,
                    const char *data,
                    size_t count);
...
bool string_equals_data_at_fast(String *array,
                                size_t index,
                                const char *data,
                                size_t len);
int string_equals_data_at(String *array,
                          size_t index,
                          const char *data,
                          size_t len,
                          bool *equal);
...
bool string_starts_with_data(String *array,
                             const char *data,
                             size_t len,
                             bool *equal);

bool string_ends_with_data_fast(String *array, const char *data, size_t len);
int string_ends_with_data(String *array,
                          const char *data,
                          size_t len,
                          bool *equal);

void string_shift_data_right_fast_no_zero(String *array,
                                          size_t index,
                                          size_t count);
void string_shift_data_right_fast(String *array, size_t index, size_t count);
int string_shift_data_right_no_zero(String *array, size_t index, size_t count);
int string_shift_data_right(String *array, size_t index, size_t count);

void string_shift_data_left_fast_no_zero(String *array,
                                         size_t index,
                                         size_t count);
void string_shift_data_left_fast(String *array, size_t index, size_t count);
int string_shift_data_left_no_zero(String *array, size_t index, size_t count);
...
void string_insert_many_fast(String *array,
                             size_t index,
                             const char *data,
                             size_t count);
int string_insert_many(String *array,
                       size_t index,
                       const char *data,
                       size_t count);
...
void string_delete_many_fast_no_zero(String *array,
                                     size_t index,
                                     size_t count);
...
void string_copy_data_fast(String *array,
                           size_t index,
                           size_t count,
                           char *data);
...
void string_pop_unordered_fast_no_zero(String *array,
                                       size_t index,
                                       char *element);
...
bool sslice_equals_data_at_fast(SSlice *slice,
                                size_t index,
                                size_t len,
                                const char *data);
int sslice_equals_data_at(SSlice *slice,
                          size_t index,
                          size_t len,
                          const char *data,
                          bool *equal);
...
bool sslice_starts_with_data_fast(SSlice *slice, const char *data, size_t len);
int sslice_starts_with_data(SSlice *slice,
                            const char *data,
                            size_t len,
                            bool *equal);

bool sslice_ends_with_data_fast(SSlice *slice, const char *data, size_t len);
int sslice_ends_with_data(SSlice *slice,
                          const char *data,
                          size_t len,
                          bool *equal);

void sslice_copy_data_fast(SSlice *slice, size_t index, size_t len, char *out);
