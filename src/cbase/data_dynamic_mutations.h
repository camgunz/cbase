...
#ifndef _CBASE_DATA_DYNAMIC_MUTATIONS_H__
#define _CBASE_DATA_DYNAMIC_MUTATIONS_H__
...
#define CBASE_DATA_DYNAMIC_MUTATIONS_IMPL(_api, _dname, _dtype)               \
    _api void _dname##_move_right_no_zero_no_check(_dtype *data,              \
                                                   size_t *dlen,              \
                                                   size_t index,              \
                                                   size_t count) {            \
    ...
    _api int _dname##_prepend(_dtype **data,                                  \
                              ...
                              const _dtype *data2,                            \
                              size_t count) {                                 \
        return _dname##_insert(data, dlen, dcap, 0, data2, count);            \
    }                                                                         \
                                                                              \
    _api _dtype *_dname##_append_slot_no_zero_no_check(_dtype *data,          \
                                                       size_t *dlen) {        \
