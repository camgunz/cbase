...
int utf8_decode_len(const char *data, size_t byte_len, rune *r,
...
int utf8_index_rune_len(const char *data, size_t byte_len,
                                          size_t index,
                                          rune *r,
                                          size_t *rune_byte_len);
...
void utf8_index_reverse_fast(const char *data, size_t byte_len, size_t index,
                                                                char **cursor);

int utf8_index_reverse(const char *data, size_t byte_len, size_t index,
                                                          char **cursor);
...
int utf8_index_rune_len_reverse(const char *data, size_t byte_len,
                                                  size_t index,
                                                  rune *r,
                                                  size_t *rune_byte_len);
...
int utf8_index_rune_reverse(const char *data, size_t byte_len, size_t index,
                                                               rune *r);

void utf8_find_data_fast(const char *haystack, size_t hlen,
                         const char *needle,   size_t nlen,
                                               bool *found,
                                               size_t *location);

int utf8_find_data(const char *haystack, size_t hlen,
                   const char *needle,   size_t nlen,
                                         bool *found,
                                         size_t *location);
...
int utf8_get_first_rune_len(const char *data, size_t byte_len,
                                              rune *r,
                                              size_t *rune_byte_len);
...
int utf8_get_last_rune_len(const char *data, size_t byte_len,
                                             rune *r,
                                             size_t *rune_byte_len);
...
int utf8_slice(const char *data, size_t byte_len, size_t index, size_t len,
                                                                char **start,
                                                                char **end);
...
int utf8_starts_with_data(const char *s1, size_t byte_len1,
                          const char *s2, size_t byte_len2,
                                          bool *starts_with);

bool utf8_starts_with_rune_fast(const char *data, rune r);

int utf8_starts_with_rune(const char *data, size_t byte_len,
                                            rune r,
                                            bool *starts_with);
...
int utf8_ends_with_data(const char *s1, size_t byte_len1,
                        const char *s2, size_t byte_len2,
                                        bool *ends_with);

bool utf8_ends_with_rune_fast(const char *data, size_t byte_len, rune r);

int utf8_ends_with_rune(const char *data, size_t byte_len, rune r,
                                                           bool *ends_with);
...
void utf8_iterate_rune_len_fast(char **data, size_t *byte_len,
                                             rune *r,
                                             size_t *rune_byte_len);

int utf8_iterate_rune_len(char **data, size_t *byte_len,
                                       rune *r,
                                       size_t *rune_byte_len);
...
void utf8_iterate_rune_len_reverse_fast(char **data, size_t *byte_len,
                                                     rune *r,
                                                     size_t *rune_byte_len);

int utf8_iterate_rune_len_reverse(char **data, size_t *byte_len,
                                               rune *r,
                                               size_t *rune_byte_len);
...
void utf8_skip_runes_if_matching_fast(char **data, size_t *len,
                                                   RuneMatchFunc *matches);

int utf8_skip_runes_if_matching(char **data, size_t *len,
                                             RuneMatchFunc *matches);

int utf8_skip_rune_if_matches(char **data, size_t *len,
                                           RuneMatchFunc *matches);
...
void utf8_pop_rune_if_matching_fast(char **data, size_t *len,
                                                 RuneMatchFunc *matches,
                                                 rune *r);

int utf8_pop_rune_if_matching(char **data, size_t *len, RuneMatchFunc *matches,
                                                        rune *r);

int utf8_pop_rune_if_equals(char **data, size_t *len, RuneMatchFunc *matches,
                                                      rune *r);

int utf8_seek_to_data(char **data, size_t *len, const char *data2,
                                                size_t len2);
...
void utf8_truncate_runes_fast(const char *data, size_t *len, size_t rune_count);
...
void utf8_truncate_if_matching_fast(const char *data, size_t *len,
                                                      RuneMatchFunc *matches);

int utf8_truncate_if_matching(const char *data, size_t *len,
                                                RuneMatchFunc *matches);
