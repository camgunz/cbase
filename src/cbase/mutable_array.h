...
#define CBASE_MUTABLE_ARRAY_IMPL_NO_DEPS(_api,                                \
    ...
    _api int _aname##_mutable_index(_atype *array,                            \
                                    size_t index,                             \
                                    _etype **element) {                       \
        CBASE_DELEGATE(_dname##_mutable_index(array->data,                    \
                                              array->len,                     \
                                              index,                          \
                                              *element));                     \
    }                                                                         \
    ...
    _api int _aname##_ensure_capacity_no_zero(_atype *array,                  \
                                              size_t *dcap,                   \
                                              size_t cap) {                   \
        CBASE_DELEGATE(_dname##_ensure_capacity_no_zero(_etype **data,        \
                                                        size_t *dcap,         \
                                                        size_t cap));         \
    }                                                                         \
                                                                              \
    _api int _aname##_ensure_capacity(_atype *array,                          \
                                      size_t *dcap,                           \
                                      size_t cap) {                           \
        CBASE_DELEGATE(_dname##_ensure_capacity(&array->data, dcap, cap));    \
    }                                                                         \
                                                                              \
    _api int _aname##_set_capacity_no_zero_no_check(_atype *array,            \
                                                    size_t *dcap,             \
    ...
    _api int _aname##_set_capacity_no_zero(_atype *array,                     \
                                           ...
                                           size_t cap) {                      \
        CBASE_DELEGATE(                                                       \
            _dname##_set_capacity_no_zero(&array->data, dcap, cap));          \
    }                                                                         \
                                                                              \
    _api int _aname##_set_capacity_no_check(_atype *array,                    \
                                            size_t *dcap,                     \
                                            size_t cap) {                     \
        CBASE_DELEGATE(                                                       \
            _dname##_set_capacity_no_check(&array->data, dcap, cap));         \
    }                                                                         \
                                                                              \
    _api int _aname##_set_capacity(_atype *array, size_t *dcap, size_t cap) { \
        CBASE_DELEGATE(_dname##_set_capacity(&array->data, dcap, cap));       \
    }                                                                         \
                                                                              \
    _api void _aname##_set_no_check(_atype *array,                            \
                                    size_t index,                             \
    ...
    _api int _aname##_set(_atype *array,                                      \
                          ...
                          size_t count) {                                     \
        CBASE_DELEGATE(                                                       \
            _dname##_set(array->data, array->len, index, data2, count));      \
    }                                                                         \
                                                                              \
    _api void _aname##_truncate_no_check(_atype *array, size_t new_length) {  \
    ...
    _api void _aname##_compact_no_check(size_t *dcap) {                       \
        _dname##_compact_no_check(array->len, dcap);                          \
                                                                              ...
                                                                              \
    _api int _aname##_compact(size_t *dcap) {                                 \
        CBASE_DELEGATE(_dname##_compact(array->len, dcap));                   \
    }                                                                         \
                                                                              \
    _api void _aname##_move_right_no_zero_no_check(_atype *array,             \
                                                   size_t index,              \
    ...
    _api int _aname##_move_right_no_zero(_atype *array,                       \
                                         size_t index,                        \
                                         size_t count) {                      \
        CBASE_DELEGATE(_dname##_move_right_no_zero(_etype **data,             \
                                                   &array->len,               \
                                                   index,                     \
                                                   count));                   \
    }                                                                         \
    ...
    _api int _aname##_move_right(_atype *array, size_t index, size_t count) { \
        CBASE_DELEGATE(                                                       \
            _dname##_move_right(_etype **data, &array->len, index, count));   \
    }                                                                         \
                                                                              \
    _api void _aname##_move_left_no_zero_no_check(_atype *array,              \
                                                  size_t index,               \
    ...
    _api int _aname##_insert_slot_no_zero(_atype *array,                      \
                                          ...
                                          _etype const **new_slot) {          \
        CBASE_DELEGATE(                                                       \
            _dname##_insert_slot_no_zero(_etype **data,                       \
                                         &array->len,                         \
                                         index,                               \
                                         _etype const **new_slot));           \
    }                                                                         \
    ...
    _api int _aname##_insert_slot(_atype *array,                              \
                                  size_t index,                               \
                                  _etype const **new_slot) {                  \
        CBASE_DELEGATE(_dname##_insert_slot(_etype **data,                    \
                                            &array->len,                      \
                                            index,                            \
                                            _etype const **new_slot));        \
    }                                                                         \
    ...
    _api int _aname##_insert(_atype *array,                                   \
                             ...
                             _etype *data2,                                   \
                             size_t count) {                                  \
        CBASE_DELEGATE(_dname##_insert(_etype **data,                         \
                                       &array->len,                           \
                                       index,                                 \
                                       data2,                                 \
                                       count));                               \
    ...
    _api _etype *_aname##_prepend_slot_no_zero_no_check(_atype *array) {              \
        CBASE_DELEGATE(                                                       \
            _dname##_prepend_slot_no_zero_no_check(array->data, &array->len));        \
    }                                                                         \
                                                                              \
    _api int _aname##_prepend_slot_no_zero(_atype *array,                     \
                                           _etype const **new_slot) {         \
        CBASE_DELEGATE(                                                       \
            _dname##_prepend_slot_no_zero(_etype **data,                      \
                                          &array->len,                        \
                                          _etype const **new_slot));          \
    }                                                                         \
                                                                              \
    _api _etype *_aname##_prepend_slot_no_check(_atype *array) {              \
        CBASE_DELEGATE(                                                       \
            _dname##_prepend_slot_no_check(array->data, &array->len));        \
                                                                              ...
                                                                              \
    _api int _aname##_prepend_slot(_atype *array, _etype const **new_slot) {  \
        CBASE_DELEGATE(_dname##_prepend_slot(_etype **data,                   \
                                             &array->len,                     \
                                             _etype const **new_slot));       \
    }                                                                         \
                                                                              \
    ...
    _api int _aname##_prepend(_atype *array, _etype *data2, size_t count) {   \
        CBASE_DELEGATE(                                                       \
            _dname##_prepend(_etype **data, &array->len, data2, count));      \
    }                                                                         \
                                                                              \
    ...
    _api int _aname##_append_slot_no_zero(_atype *array,                      \
                                          _etype const **new_slot) {          \
        CBASE_DELEGATE(                                                       \
            _dname##_append_slot_no_zero(_etype **data,                       \
                                         &array->len,                         \
                                         _etype const **new_slot));           \
    }                                                                         \
                                                                              \
    _api _etype *_aname##_append_slot_no_check(_atype *array) {               \
        CBASE_DELEGATE(                                                       \
            _dname##_append_slot_no_check(array->data, &array->len));         \
                                                                              ...
                                                                              \
    _api int _aname##_append_slot(_atype *array, _etype const **new_slot) {   \
        CBASE_DELEGATE(_dname##_append_slot(_etype **data,                    \
                                            &array->len,                      \
                                            _etype const **new_slot));        \
    }                                                                         \
                                                                              \
    ...
    _api int _aname##_append(_atype *array, _etype *data2, size_t count) {    \
        CBASE_DELEGATE(                                                       \
            _dname##_append(_etype **data, &array->len, data2, count));       \
    }                                                                         \
                                                                              \
    _api void _aname##_delete_no_zero_no_check(_atype *array,                 \
                                               size_t index,                  \
    ...
    _api int _aname##_delete_no_zero(_atype *array,                           \
                                     size_t index,                            \
                                     size_t count) {                          \
        CBASE_DELEGATE(_dname##_delete_no_zero(_etype **data,                 \
                                               &array->len,                   \
                                               index,                         \
                                               count));                       \
    }                                                                         \
