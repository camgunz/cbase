...
#define TABLE_DECL(_ttype, _tname, _ktype, _otype)                   \
    typedef struct _ttype ## BucketStruct {                          \
        ...
        _otype obj;                                                  \
                                                                     ...
                                                                     \
    ARRAY_DEF(_ttype ## BucketArray, _tname ## _bucket_array,        \
                                     _ttype ## Bucket)               \
                                                                     \
    typedef size_t(_ttype ## GetHashFromKey)(                        \
        const _ktype key, size_t seed                                \
    );                                                               \
                                                                     \
    typedef _ktype*(_ttype ## GetKeyFromObj)(const _otype obj);      \
                                                                     \
    typedef bool(_ttype ## KeyEqual)(                                \
        const _ktype key1, const _ktype key2                         \
    );                                                               \
                                                                     \
...
#define TABLE_IMPL(_ttype, _tname, _ktype, _otype, _key_to_hash, _obj_to_key, \
                   _keys_equal)                                               \
    static inline                                                             \
    void _tname ## _reset_buckets(_ttype *table) {                            \
        _tname ## _bucket_array_clear(&table->buckets);                       \
        table->buckets.len = table->bucket_max;                               \
                                                                              \
        for (size_t i = 0; i < table->buckets.alloc; i++) {                   \
            _ttype ## Bucket *bucket = _tname ## _bucket_array_index_fast(    \
                &table->buckets, i                                            \
            );                                                                \
            bucket->distance = SIZE_MAX;                                      \
                                                                              ...
                                                                              \
    static inline                                                             \
    int _tname ## _resize(_ttype *table, size_t new_bucket_bit) {             \
        ...
        return 0;                                                             \
                                                                              ...
                                                                              \
    static inline                                                             \
    int _tname ## _check_grow(_ttype *table) {                                \
        ...
        return 0;                                                             \
                                                                              ...
                                                                              \
    static inline                                                             \
    int _tname ## _check_shrink(_ttype *table) {                              \
        float load_level = ((float)table->len) / ((float)table->bucket_max);  \
                                                                              \
        ...
        return _tname ## _resize(table, table->bucket_bit - 1);               \
                                                                              ...
                                                                              \
    static inline                                                             \
    int _tname ## _init(_ttype *table, size_t seed) {                         \
        table->seed = seed;                                                   \
        ...
        for (size_t i = 0; i < table->bucket_max; i++) {                      \
            _tname ## _bucket_array_index_fast(                               \
                &table->buckets,                                              \
                i                                                             \
            )->distance = SIZE_MAX;                                           \
        }                                                                     \
        ...
        return 0;                                                             \
                                                                              ...
                                                                              \
    static inline                                                             \
    int _tname ## _insert(_ttype *table, _otype obj) {                        \
        ...
        return CBASE_TABLE_FULL;                                              \
                                                                              ...
                                                                              \
    static inline                                                             \
    int _tname ## _remove(_ttype *table, const _ktype key) {                  \
        _ttype ## BucketArray *buckets = &table->buckets;                     \
        ...
        return CBASE_ERROR_NOT_FOUND;                                         \
                                                                              ...
                                                                              \
    static inline                                                             \
    int _tname ## _pop(_ttype *table, const _ktype key, _otype *obj) {        \
        _ttype ## BucketArray *buckets = &table->buckets;                     \
        size_t hash = _key_to_hash(key, table->seed);                         \
        size_t start = hash;                                                  \
                                                                              \
        ...
        return CBASE_ERROR_NOT_FOUND;                                         \
                                                                              ...
                                                                              \
    static inline                                                             \
    int _tname ## _lookup(_ttype *table, const _ktype key, _otype *obj) {     \
        _ttype ## BucketArray *buckets = &table->buckets;                     \
        size_t hash = _key_to_hash(key, table->seed);                         \
        size_t start = hash;                                                  \
                                                                              \
        ...
        return CBASE_ERROR_NOT_FOUND;                                         \
                                                                              ...
                                                                              \
    static inline                                                             \
    bool _tname ## _iterate(_ttype *table, size_t *index, _otype *obj) {      \
        size_t i = 0;                                                         \
                                                                              \
        if (*obj) {                                                           \
            i = (*index) + 1;                                                 \
        ...
        *index = 0;                                                           \
        ...
        return false;                                                         \
                                                                              ...
                                                                              \
    static inline                                                             \
    void _tname ## _clear(_ttype *table) {                                    \
        table->bucket_bit = CBASE_TABLE_START_BIT;                            \
        table->bucket_max = 1 << table->bucket_bit;                           \
        table->bucket_mask = table->bucket_max - 1;                           \
        table->len = 0;                                                       \
        ...
        _tname ## _reset_buckets(table);                                      \
                                                                              ...
                                                                              \
    static inline                                                             \
    void _tname ## _free(_ttype *table) {                                     \
        ...
        table->len = 0;                                                       \
                                                                              ...
                                                                              \
    static inline                                                             \
    int _tname ## _copy(_ttype *dst, _ttype *src) {                           \
        size_t index = 0;                                                     \
        _otype obj = NULL;                                                    \
                                                                              \
        _tname ## _clear(dst);                                                \
...
#define TABLE_DEF(_ttype, _tname, _ktype, _otype, _key_to_hash, _obj_to_key, \
                  _keys_equal)                                               \
    TABLE_DECL(_ttype, _tname, _ktype, _otype)                               \
    TABLE_IMPL(_ttype, _tname, _ktype, _otype, _key_to_hash, _obj_to_key,    \
                   _keys_equal)
...
#define STR_TABLE_IMPL(_ttype, _tname, _otype, _obj_to_key)                \
    TABLE_IMPL(_ttype, _tname, char *, _otype, hash64_string, _obj_to_key, \
               cstr_equal)
...
#define UINT_TABLE_IMPL(_ttype, _tname, _otype, _obj_to_key)                 \
    TABLE_IMPL(_ttype, _tname, uint64_t, _otype, hash64_string, _obj_to_key, \
               cstr_equal)
...
#define INT_TABLE_IMPL(_ttype, _tname, _otype, _obj_to_key)                 \
    TABLE_IMPL(_ttype, _tname, int64_t, _otype, hash64_string, _obj_to_key, \
               cstr_equal)
...
#define UINT32_TABLE_IMPL(_ttype, _tname, _otype, _obj_to_key)                \
    TABLE_IMPL(_ttype, _tname, uint32_t, _otype, hash32_string, _obj_to_key,  \
               cstr_equal)
...
#define INT32_TABLE_IMPL(_ttype, _tname, _otype, _obj_to_key)                \
    TABLE_IMPL(_ttype, _tname, int32_t, _otype, hash32_string, _obj_to_key,  \
               cstr_equal)
