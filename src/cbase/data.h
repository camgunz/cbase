...
#define CBASE_MUTABLE_STATIC_DATA_IMPL_DECL(_api, _dname, _dtype) \
    CBASE_DATA_BASE(_api, _dname, _dtype) \
    CBASE_DATA_SLICE_MANAGEMENT(_api, _dname, _dtype) \
    CBASE_DATA_STATIC_MANAGEMENT(_api, _dname, _dtype) \
    CBASE_DATA_SLICE_MUTATIONS(_api, _dname, _dtype) \
    CBASE_DATA_STATIC_MUTATIONS(_api, _dname, _dtype)
...
#define CBASE_MUTABLE_DYNAMIC_DATA_IMPL_DECL(_api, _dname, _dtype) \
    CBASE_DATA_BASE(_api, _dname, _dtype) \
    CBASE_DATA_SLICE_MANAGEMENT(_api, _dname, _dtype) \
    CBASE_DATA_DYNAMIC_MANAGEMENT(_api, _dname, _dtype) \
    CBASE_DATA_SLICE_MUTATIONS(_api, _dname, _dtype) \
    CBASE_DATA_DYNAMIC_MUTATIONS(_api, _dname, _dtype)
