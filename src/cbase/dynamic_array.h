...
#define CBASE_DYNAMIC_DATA_IMPL_DECL(_scope, _dname, _dtype)             \
    ...
    _scope int _dname##_ensure_capacity_no_check(_dtype **data,               \
                                                 ...
                                                 size_t cap);                 \
                                                                              \
    _scope void _dname##_init_no_check(size_t *dlen, size_t *dcap);           \
                                                                              \
    _scope int _dname##_init(size_t *dlen, size_t *dcap);                     \
                                                                              \
    _scope int _dname##_init_capacity_no_check(_dtype **data,                 \
                                               size_t *dlen,                  \
                                               size_t *dcap,                  \
                                               size_t cap);                   \
                                                                              \
    _scope int _dname##_init_capacity(_dtype **data,                          \
                                      size_t *dlen,                           \
                                      size_t *dcap,                           \
                                      size_t cap);                            \
                                                                              \
    _scope int _dname##_init_from_data_no_check(_dtype **data,                \
                                                ...
                                                size_t len2);                 \
                                                                              \
    _scope void _dname##_free_no_zero_no_check(_dtype *data,                  \
                                               size_t *dlen,                  \
                                               size_t *dcap);                 \
                                                                              \
    _scope int _dname##_free_no_zero(_dtype *data,                            \
                                     size_t *dlen,                            \
                                     size_t *dcap);                           \
                                                                              \
    _scope void _dname##_free_no_check(_dtype *data,                          \
                                       size_t *dlen,                          \
                                       size_t *dcap);                         \
                                                                              \
    _scope int _dname##_free(_dtype *data, size_t *dlen, size_t *dcap);       \
                                                                              \
    _scope void _dname##_destroy_no_zero_no_check(_dtype **data,              \
                                                  size_t *dlen,               \
                                                  size_t *dcap);              \
                                                                              \
    _scope int _dname##_destroy_no_zero(_dtype **data,                        \
                                        size_t *dlen,                         \
                                        size_t *dcap);                        \
                                                                              \
    _scope void _dname##_destroy_no_check(_dtype **data,                      \
                                          size_t *dlen,                       \
                                          size_t *dcap);                      \
                                                                              \
    _scope int _dname##_destroy(_dtype **data, size_t *dlen, size_t *dcap);


#define CBASE_DYNAMIC_DATA_IMPL(_scope, _dname, _dtype)                  \
