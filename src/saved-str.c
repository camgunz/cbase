...
void string_assign_cstr_full_fast(String *string,
                                  const char *cs,
                                  size_t len,
                                  size_t byte_len) {
...
int string_assign_cstr_full(String *string,
                            const char *cs,
                            size_t len,
                            size_t byte_len) {
...
void string_assign_utf8_data_full_fast(String *string,
                                       const char *data,
                                       size_t len,
                                       size_t byte_len) {
...
int string_assign_utf8_data_full(String *string,
                                 const char *data,
                                 size_t len,
                                 size_t byte_len) {
...
void string_assign_utf8_data_fast(String *string,
                                  const char *data,
                                  size_t byte_len) {
    size_t len = 0;
...
int string_assign_utf8_data(String *string,
                            const char *data,
                            size_t byte_len) {
    size_t len = 0;
...
void string_assign_sslice_fast(String *string, SSlice *sslice) {
    string_assign_utf8_data_full_fast(string,
                                      sslice->data,
                                      sslice->len,
                                      sslice->byte_len);
}
...
int string_assign_sslice(String *string, SSlice *sslice) {
    return string_assign_utf8_data_full(string,
                                        sslice->data,
                                        sslice->len,
                                        sslice->byte_len);
}

int string_assign_data_fast(String *string,
                            const char *data,
                            size_t byte_len,
                            const char *encoding) {
    Buffer input;
...
int string_assign_data(String *string,
                       const char *data,
                       size_t byte_len,
                       const char *encoding) {
    Buffer input;
...
int string_assign_slice_fast(String *string,
                             Slice *slice,
                             const char *encoding) {
...
int string_assign_buffer_fast(String *string,
                              Buffer *buffer,
                              const char *encoding) {
    return string_assign_data_fast(string,
                                   buffer->data,
                                   buffer->len,
                                   encoding);
}

int string_assign_buffer(String *string,
                         Buffer *buffer,
                         const char *encoding) {
    return string_assign_data(string, buffer->data, buffer->len, encoding);
}

void string_assign_utf8_buffer_full_fast(String *string,
                                         Buffer *buffer,
                                         size_t len) {
    string_assign_utf8_data_full_fast(string, buffer->data, len, buffer->len);
}

int string_assign_utf8_buffer_full(String *string,
                                   Buffer *buffer,
                                   size_t len) {
    return string_assign_utf8_data_full(string,
                                        buffer->data,
...
int string_init_from_cstr_full(String *string,
                               const char *cs,
                               size_t len,
                               size_t byte_len) {
    string_init(string);
...
int string_init_from_utf8_data(String *string,
                               const char *data,
                               size_t byte_len) {
    string_init(string);
...
int string_init_from_utf8_data_full(String *string,
                                    const char *data,
                                    size_t len,
                                    size_t byte_len) {
    string_init(string);
...
int string_init_from_slice(String *string,
                           Slice *slice,
                           const char *encoding) {
    string_init(string);
...
int string_init_from_buffer(String *string,
                            Buffer *buffer,
                            const char *encoding) {
    string_init(string);
...
int string_new_alloc(String **string, size_t alloc) {
    CBASE_PROPAGATE_ERROR(cbmalloc(1, sizeof(String), string));
    CBASE_FREE_AND_PROPAGATE_ERROR(string_init_alloc(*string, alloc),
                                   cbfree,
                                   *string);
...
int string_new_from_cstr(String **string, const char *cs) {
    CBASE_PROPAGATE_ERROR(cbmalloc(1, sizeof(String), string));
    CBASE_FREE_AND_PROPAGATE_ERROR(string_init_from_cstr(*string, cs),
                                   cbfree,
                                   *string);
...
int string_new_from_cstr_full(String **string,
                              const char *cs,
                              size_t len,
                              size_t byte_len) {
    CBASE_PROPAGATE_ERROR(cbmalloc(1, sizeof(String), string));
...
int string_new_from_utf8_data_full(String **string,
                                   const char *data,
                                   size_t len,
                                   size_t byte_len) {
    CBASE_PROPAGATE_ERROR(cbmalloc(1, sizeof(String), string));
...
int string_new_from_sslice(String **string, SSlice *sslice) {
    CBASE_PROPAGATE_ERROR(cbmalloc(1, sizeof(String), string));
    CBASE_FREE_AND_PROPAGATE_ERROR(string_init_from_sslice(*string, sslice),
                                   cbfree,
                                   *string);
...
int string_new_from_string(String **string, String *input) {
    CBASE_PROPAGATE_ERROR(cbmalloc(1, sizeof(String), string));
    CBASE_FREE_AND_PROPAGATE_ERROR(string_init_from_string(*string, input),
                                   cbfree,
                                   *string);
...
int string_new_from_slice(String **string,
                          Slice *slice,
                          const char *encoding) {
    CBASE_PROPAGATE_ERROR(cbmalloc(1, sizeof(String), string));
    CBASE_FREE_AND_PROPAGATE_ERROR(string_init_from_slice(*string,
                                                          slice,
                                                          encoding),
                                   cbfree,
                                   *string);
...
int string_new_from_utf8_slice(String **string, Slice *slice) {
    CBASE_PROPAGATE_ERROR(cbmalloc(1, sizeof(String), string));
    CBASE_FREE_AND_PROPAGATE_ERROR(string_init_from_utf8_slice(*string, slice),
                                   cbfree,
                                   *string);
...
int string_new_from_local_slice(String **string, Slice *slice) {
    CBASE_PROPAGATE_ERROR(cbmalloc(1, sizeof(String), string));
    CBASE_FREE_AND_PROPAGATE_ERROR(string_init_from_local_slice(*string,
                                                                slice),
                                   cbfree,
                                   *string);
...
int string_new_from_buffer(String **string,
                           Buffer *buffer,
                           const char *encoding) {
    CBASE_PROPAGATE_ERROR(cbmalloc(1, sizeof(String), string));
    CBASE_FREE_AND_PROPAGATE_ERROR(string_init_from_buffer(*string,
                                                           buffer,
                                                           encoding),
                                   cbfree,
                                   *string);
...
int string_new_from_utf8_buffer(String **string, Buffer *buffer) {
    CBASE_PROPAGATE_ERROR(cbmalloc(1, sizeof(String), string));
    CBASE_FREE_AND_PROPAGATE_ERROR(string_init_from_utf8_buffer(*string,
                                                                buffer),
                                   cbfree,
                                   *string);
...
int string_new_from_local_buffer(String **string, Buffer *buffer) {
    CBASE_PROPAGATE_ERROR(cbmalloc(1, sizeof(String), string));
    CBASE_FREE_AND_PROPAGATE_ERROR(string_init_from_local_buffer(*string,
                                                                 buffer),
                                   cbfree,
                                   *string);
...
int string_index_rune_reverse(String *string, size_t index, rune *r) {
    return strbase_index_rune_reverse(string->buffer.data,
                                      string->len,
                                      index,
                                      r);
}
...
bool string_equals_utf8_data(String *string,
                             const char *data,
                             size_t byte_len) {
...
int string_starts_with_cstr_len(String *string,
                                const char *cs,
                                size_t byte_len,
                                bool *starts_with) {
    int error =
        buffer_equals_data_at(&string->buffer, 0, cs, byte_len, starts_with);
...
int string_starts_with_cstr(String *string,
                            const char *cs,
                            bool *starts_with) {
...
int string_ends_with_utf8_data(String *string,
                               const char *cs,
                               size_t byte_len,
                               bool *ends_with) {
    size_t index = string->buffer.len - byte_len;

    return buffer_equals_data_at(&string->buffer,
                                 index,
                                 cs,
                                 byte_len,
                                 ends_with);
...
void string_slice_fast(String *string,
                       size_t index,
                       size_t len,
                       SSlice *sslice) {
    char *start = NULL;
    ...
    utf8_slice_fast(string->buffer.data,
                    string->buffer.len,
                    index,
                    len,
                    &start,
...
void string_delete_fast(String *string, size_t index, size_t rune_count) {
    ...
    if (index) {
        utf8_index_fast(string->buffer.data,
                        string->buffer.len,
                        index,
                        &start);
...
int string_delete(String *string, size_t index, size_t rune_count) {
    ...
    if (index) {
        CBASE_PROPAGATE_ERROR(utf8_index(string->buffer.data,
                                         string->buffer.len,
                                         index,
                                         &start));
...
void string_insert_cstr_full_fast(String *string,
                                  size_t index,
                                  const char *cs,
                                  size_t len,
                                  size_t byte_len) {
...
int string_insert_cstr_full(String *string,
                            size_t index,
                            const char *cs,
                            size_t len,
                            size_t byte_len) {
...
void string_insert_utf8_data_full_fast(String *string,
                                       size_t index,
                                       const char *data,
                                       size_t len,
                                       size_t byte_len) {
...
int string_insert_utf8_data_full(String *string,
                                 size_t index,
                                 const char *data,
                                 size_t len,
                                 size_t byte_len) {
...
void string_insert_utf8_data_fast(String *string,
                                  size_t index,
                                  const char *data,
                                  size_t byte_len) {
    size_t len = 0;
...
int string_insert_utf8_data(String *string,
                            size_t index,
                            const char *data,
                            size_t byte_len) {
    size_t len = 0;
...
void string_insert_sslice_fast(String *string, size_t index, SSlice *sslice) {
    string_insert_utf8_data_full_fast(string,
                                      index,
                                      sslice->data,
                                      sslice->len,
                                      sslice->byte_len);
...
int string_insert_sslice(String *string, size_t index, SSlice *sslice) {
    return string_insert_utf8_data_full(string,
                                        index,
                                        sslice->data,
                                        sslice->len,
                                        sslice->byte_len);
...
void string_insert_string_fast(String *dst, size_t index, String *src) {
    string_insert_cstr_full_fast(dst,
                                 index,
                                 src->buffer.data,
                                 src->len,
                                 src->buffer.len);
...
int string_insert_string(String *dst, size_t index, String *src) {
    return string_insert_cstr_full(dst,
                                   index,
                                   src->buffer.data,
                                   src->len,
                                   src->buffer.len);
...
int string_insert_slice_fast(String *string,
                             size_t index,
                             Slice *slice,
                             const char *encoding) {
    Buffer output;
...
int string_insert_slice(String *string,
                        size_t index,
                        Slice *slice,
                        const char *encoding) {
    Buffer output;
...
void string_insert_utf8_slice_fast(String *string,
                                   size_t index,
                                   Slice *slice) {
...
int string_insert_local_slice_fast(String *string,
                                   size_t index,
                                   Slice *slice) {
...
int string_insert_buffer_fast(String *string,
                              size_t index,
                              Buffer *buffer,
                              const char *encoding) {
    Buffer output;
...
int string_insert_buffer(String *string,
                         size_t index,
                         Buffer *buffer,
                         const char *encoding) {
    Buffer output;
...
int string_insert_utf8_buffer_fast(String *string,
                                   size_t index,
                                   Buffer *buffer) {
...
int string_insert_local_buffer_fast(String *string,
                                    size_t index,
                                    Buffer *buffer) {
...
int string_insert_data_fast(String *string,
                            size_t index,
                            const char *data,
                            size_t byte_len,
                            const char *encoding) {
...
int string_insert_data(String *string,
                       size_t index,
                       const char *data,
                       size_t byte_len,
                       const char *encoding) {
...
int string_insert_local_data_fast(String *string,
                                  size_t index,
                                  const char *data,
                                  size_t byte_len) {
...
int string_insert_local_data(String *string,
                             size_t index,
                             const char *data,
                             size_t byte_len) {
...
void string_prepend_cstr_full_fast(String *string,
                                   const char *cs,
                                   size_t len,
                                   size_t byte_len) {
...
int string_prepend_cstr_full(String *string,
                             const char *cs,
                             size_t len,
                             size_t byte_len) {
...
void string_prepend_utf8_data_full_fast(String *string,
                                        const char *data,
                                        size_t len,
                                        size_t byte_len) {
...
int string_prepend_utf8_data_full(String *string,
                                  const char *data,
                                  size_t len,
                                  size_t byte_len) {
...
int string_prepend_utf8_data(String *string,
                             const char *data,
                             size_t byte_len) {
...
int string_prepend_slice_fast(String *string,
                              Slice *slice,
                              const char *encoding) {
...
int string_prepend_buffer_fast(String *string,
                               Buffer *buffer,
                               const char *encoding) {
    return string_insert_buffer_fast(string, 0, buffer, encoding);
}

int string_prepend_buffer(String *string,
                          Buffer *buffer,
                          const char *encoding) {
...
int string_prepend_data_fast(String *string,
                             const char *data,
                             size_t byte_len,
                             const char *encoding) {
...
int string_prepend_data(String *string,
                        const char *data,
                        size_t byte_len,
                        const char *encoding) {
...
int string_prepend_local_data_fast(String *string,
                                   const char *data,
                                   size_t byte_len) {
    return string_insert_local_data_fast(string, 0, data, byte_len);
}

int string_prepend_local_data(String *string,
                              const char *data,
                              size_t byte_len) {
    return string_insert_local_data(string, 0, data, byte_len);
}

void string_append_cstr_full_fast(String *string,
                                  const char *cs,
                                  size_t len,
                                  size_t byte_len) {
...
int string_append_cstr_full(String *string,
                            const char *cs,
                            size_t len,
                            size_t byte_len) {
...
void string_append_utf8_data_full_fast(String *string,
                                       const char *data,
                                       size_t len,
                                       size_t byte_len) {
    string_insert_utf8_data_full_fast(string,
...
int string_append_utf8_data_full(String *string,
                                 const char *data,
                                 size_t len,
                                 size_t byte_len) {
    return string_insert_utf8_data_full(string,
...
int string_append_utf8_data(String *string,
                            const char *data,
                            size_t byte_len) {
...
int string_append_slice_fast(String *string,
                             Slice *slice,
                             const char *encoding) {
...
int string_append_buffer_fast(String *string,
                              Buffer *buffer,
                              const char *encoding) {
    return string_insert_buffer_fast(string, string->len, buffer, encoding);
}

int string_append_buffer(String *string,
                         Buffer *buffer,
                         const char *encoding) {
...
int string_append_data_fast(String *string,
                            const char *data,
                            size_t byte_len,
                            const char *encoding) {
    return string_insert_data_fast(string,
                                   string->len,
                                   data,
                                   byte_len,
                                   encoding);
...
int string_append_data(String *string,
                       const char *data,
                       size_t byte_len,
                       const char *encoding) {
...
int string_append_local_data_fast(String *string,
                                  const char *data,
                                  size_t byte_len) {
    return string_insert_local_data_fast(string, string->len, data, byte_len);
}

int string_append_local_data(String *string,
                             const char *data,
                             size_t byte_len) {
...
int string_encode(String *string, const char *encoding, Buffer *out) {
    return strbase_encode(string->buffer.data,
                          string->buffer.len,
                          encoding,
                          out);
}
...
string_insert_vprintf(String *string,
                      size_t index,
                      const char *fmt,
                      va_list args) {
    va_list args2;
    ...
    CBASE_PROPAGATE_ERROR(
        string_ensure_capacity(string,
                               string->buffer.len + (size_t)byte_size));
    ...
    CBASE_PROPAGATE_ERROR(
        buffer_insert_blank_data_no_zero(&string->buffer,
...
string_insert_printf(String *string, size_t index, const char *fmt, ...) {
    va_list args;
    int res = 0;
...
__attribute__((format(printf, 2, 0))) int string_vprintf(String *string,
                                                         const char *fmt,
                                                         va_list args) {
    string_clear(string);
...
__attribute__((format(printf, 2, 3))) int string_printf(String *string,
                                                        const char *fmt,
                                                        ...) {
    va_list args;
    int res = 0;
...
__attribute__((format(printf, 2, 0))) int string_init_vprintf(String *string,
                                                              const char *fmt,
                                                              va_list args) {
    string_init(string);
...
__attribute__((format(printf, 2, 3))) int string_init_printf(String *string,
                                                             const char *fmt,
                                                             ...) {
    int res = 0;
    va_list args;
...
__attribute__((format(printf, 2, 0))) int string_new_vprintf(String **string,
                                                             const char *fmt,
                                                             va_list args) {
    CBASE_PROPAGATE_ERROR(cbmalloc(1, sizeof(String), string));
...
__attribute__((format(printf, 2, 3))) int string_new_printf(String **string,
                                                            const char *fmt,
                                                            ...) {
    va_list args;
    int res = 0;
...
string_prepend_vprintf(String *string, const char *fmt, va_list args) {
    return string_insert_vprintf(string, 0, fmt, args);
}

__attribute__((format(printf, 2, 3))) int
string_prepend_printf(String *string, const char *fmt, ...) {
    va_list args;
    int res = 0;
...
__attribute__((format(printf, 2, 0))) int
string_append_vprintf(String *string, const char *fmt, va_list args) {
    return string_insert_vprintf(string, string->len, fmt, args);
}

__attribute__((format(printf, 2, 3))) int string_append_printf(String *string,
                                                               const char *fmt,
                                                               ...) {
    va_list args;
    int res = 0;
...
int string_replace_cstr(String *string,
                        const char *cs,
    ...
    CBASE_PROPAGATE_ERROR(utf8_process_cstr(cs, &cs_len, &cs_byte_len));

    CBASE_PROPAGATE_ERROR(utf8_process_cstr(replacement,
                                            &replacement_len,
    ...
    CBASE_PROPAGATE_ERROR(string_delete(string, index, cs_len));

    CBASE_PROPAGATE_ERROR(buffer_insert_data(&string->buffer,
                                             index,
                                             replacement,
                                             replacement_byte_len));
